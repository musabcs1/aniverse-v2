...
var animeList_json_1 = require("./animeList.json");
...
var importAnimeToFirestore = function () { return __awaiter(void 0, void 0, void 0, function () {
    var animeCollection, _i, animeList_1, anime, animeDoc, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
                animeCollection = (0, firestore_1.collection)(db, 'anime');
                _i = 0, animeList_1 = animeList_json_1.default;
                _a.label = 1;
            case 1:
            ...
            case 2:
                _a.sent();
                console.log("Successfully added anime: ".concat(anime.title));
                _a.label = 3;
            case 3:
                _i++;
                return [3 /*break*/, 1];
            case 4:
                console.log('All anime have been successfully imported.');
                return [3 /*break*/, 6];
            case 5:
                error_1 = _a.sent();
                console.error('Error importing anime:', error_1);
                return [3 /*break*/, 6];
            case 6: return [2 /*return*/];
        }
    });
}); };
importAnimeToFirestore();
