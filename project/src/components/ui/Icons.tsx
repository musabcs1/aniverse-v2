...
// Custom icons not found in lucide-react
export const ListPlus: React.FC<{ className?: string }> = ({ className }) => (
  <svg 
...
export const ListFilter: React.FC<{ className?: string }> = ({ className }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    width="24" 
    height="24" 
